...
describe('Moderation Component', () => {
  ...
  it('renders and interacts to maximize coverage', async () => {
    (api.get as any).mockResolvedValue({ data: { data: [{ id: '1', type: 'FAKE_JOB', status: 'PENDING', createdAt: new Date().toISOString(), reporter: { email: 'test@t.com', role: 'USER' } }], totalPages: 1 } });
