...
describe('JobsList Component', () => {
  ...
  it('renders and interacts to maximize coverage', async () => {
    (api.get as any).mockResolvedValue({ data: [{ id: '1', title: 'test', company: { name: 'test' }, status: 'PUBLISHED', description: 'test', paymentAmount: 100, createdAt: new Date().toISOString() }] });
